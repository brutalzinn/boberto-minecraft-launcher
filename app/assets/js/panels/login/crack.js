...
document.querySelector(`.uzurionAppLoginCardInformation`).innerHTML = language_service.Tradutor('authentication.crack.login_header') //"Insira seu nome de jogador para jogar no mundo bobertástico. </br> Esse launcher se destina a uso exclusivo dos meus amigos. </br>E não deve ser compartilhado com terceiros."
document.querySelector(`.uzurionAppLoginCardLabel`).innerHTML =  language_service.Tradutor('authentication.crack.login_title_text')
document.querySelector(`.form-check-label`).innerHTML =  language_service.Tradutor('authentication.login_remember_text')
document.querySelector(".loginSpanPremium").innerHTML =  language_service.Tradutor('authentication.crack.login_premium_text')
...
document.querySelector(".login-btn").addEventListener("click", () => {
    if (document.querySelector(".pseudo").value == ""){
        document.querySelector(".info-login").innerHTML =  language_service.Tradutor('authentication.crack.login_info_text')
    ...
    if (document.querySelector(".pseudo").value.length < 3) {
       document.querySelector(".info-login").innerHTML =  language_service.Tradutor('authentication.crack.login_info_text_alternative')
        document.querySelector(".info-login").style.color = "red";
        document.querySelector(".info-login").style.display = "block"
        return;
    }
