...
const config_launcher = require(dataDirectory + "/" + config.launcher_dir + "/config.json")
...
java_args_input.addEventListener('change', async function() {
    ...
    fs.writeFileSync(`${dataDirectory}/${config.launcher_dir}/config.json`, JSON.stringify(config_launcher, true, 4), 'UTF-8')
})
