...
function loadTranslation(){
   console.log('loading translators... home')
    ...
    document.querySelector(".player-connect-head-text").innerHTML = language_service.Tradutor('server_list.status_title_text')
...
document.querySelector(".play-btn").addEventListener("click", async () => {
    ...
    if (document.getElementById('force-play').checked) {
        ...
        let opts = {
            ...
            detached: true,
            args: config_launcher.Settings.Java.Args !== "" ? config_launcher.Settings.Java.Args.split() : [],
            java: config.java,
